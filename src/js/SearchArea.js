            ...
            <div>
                ...
                <div className = 'col-md-12 container-table containe-fluid'>
                    ...
                    <div class="form-group">
                      <label for="" className = "formLabel">Введите текст запроса</label>
                      <input type="text" name="" className="form-control" id="text_filter" onChange={() =>{ this.pageIndex = 0; this.componentDidMount()}} style={{padding:2}}/>
                    </div>
